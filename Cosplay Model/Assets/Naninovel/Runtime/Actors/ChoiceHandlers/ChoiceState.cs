...
namespace Naninovel
{
    ...
    public class ChoiceState
    {
        ...
        /// <summary>
        /// Whether to apply <see cref="ButtonPosition"/> (whether user provided a custom position in the novel action).
        /// </summary>
        ...
        /// <summary>
        /// Undo data of the master <see cref="Actions.AddChoice"/> action.
        /// </summary>
        public readonly Actions.AddChoice.UndoData UndoData = default;

        [SerializeField] string id;

        public ChoiceState (string summary = null, string buttonPath = null, Actions.AddChoice.UndoData undoDdata = null, Vector2? buttonPosition = null,
