...
{
    /// <summary>
    /// A <see cref="INovelActor"/> implementation using <see cref="MonoBehaviour"/> to represent an actor.
    /// </summary>
    public abstract class MonoBehaviourActor : INovelActor, IDisposable
    {
        ...
        public MonoBehaviourActor (string id, NovelActorMetadata metadata)
        {
            Id = id;
        ...
        public abstract Task PreloadResourcesAsync (string appearance = null);

        public abstract Task UnloadResourcesAsync (string appearance = null);
