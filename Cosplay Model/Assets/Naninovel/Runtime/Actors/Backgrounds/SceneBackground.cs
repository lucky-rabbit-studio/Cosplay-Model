...
namespace Naninovel
{
    ...
    public class SceneBackground : MonoBehaviourActor, IBackgroundActor
    {
        ...
        public override Task UnloadResourcesAsync (string appearance = null) => Task.CompletedTask; // managed by Dispose().
        ...
        private static void DestroySharedResources ()
        {
            ...
            foreach (var sceneData in sceneDataMap.Values)
            {
                ...
                if (Application.isPlaying) Object.Destroy(sceneData.RenderTexture);
                else Object.DestroyImmediate(sceneData.RenderTexture);
            }
