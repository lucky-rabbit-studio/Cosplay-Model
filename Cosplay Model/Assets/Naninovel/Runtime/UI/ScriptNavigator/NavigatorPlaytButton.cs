...
namespace Naninovel.UI
{
    public class NavigatorPlaytButton : ScriptableButton, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public void Initialize (ScriptNavigatorPanel navigator, NovelScript script, NovelScriptPlayer player)
        {
        ...
        {
            await stateManager.LoadDefaultEngineStateAsync(() => player.PreloadAndPlayAsync(script));
        }
