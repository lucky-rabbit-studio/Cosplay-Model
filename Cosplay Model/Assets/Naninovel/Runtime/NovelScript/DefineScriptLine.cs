...
{
    /// <summary>
    /// A <see cref="NovelScript"/> line representing a define expression.
    /// </summary>
    public class DefineScriptLine : NovelScriptLine
    {
        /// <summary>
        ...
        public DefineScriptLine (string scriptName, int lineIndex, string lineText, LiteralMap<string> scriptDefines = null) 
