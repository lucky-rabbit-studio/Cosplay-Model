...
namespace Naninovel
{
    ...
    public class ScriptsConfiguration : Configuration
    {
        ...
        [Tooltip("Configuration of the resource loader used with novel script resources.")]
        ...
        [Tooltip("Whether to allow adding external novel scripts to the build.")]
        public bool EnableCommunityModding = false;
        [Tooltip("Configuration of the resource loader used with external novel script resources.")]
        ...
        [Tooltip("Whether to initializte script navigator to browse available novel scripts.")]
        public bool EnableNavigator = true;
        [Tooltip("Whether to show novel script navigator when script manager is initialized.")]
