...
namespace Naninovel.Actions
{
    ...
    /// </example>
    [ActionAlias("choice")]
    public class AddChoice : NovelAction, NovelAction.ILocalizable, NovelAction.IPreloadable
    {
        ...
        /// The prefab should have a `Naninovel.ChoiceHandlerButton` component attached to the root object.
        /// Will use a default button when not provided.
        /// </summary>
        [ActionParameter("button", true)]
        ...
        /// See [`@goto`](/api/#goto) action for the path format.
        /// </summary>
        ...
        /// see [`@set`](/api/#set) action for syntax reference.
        /// </summary>
        ...
        public async Task PreloadResourcesAsync ()
        {
            ...
            await handler.PreloadResourcesAsync();
        }
        ...
        public async Task UnloadResourcesAsync ()
        {
            var mngr = Engine.GetService<ChoiceHandlerManager>();
            var handlerId = string.IsNullOrWhiteSpace(HandlerId) ? mngr.DefaultHandlerId : HandlerId;
            if (mngr.ActorExists(handlerId)) await mngr.GetActor(handlerId).UnloadResourcesAsync();
        }
