...
namespace Naninovel.Actions
{
        ...
        where TManager : OrthoActorManager<TActor, TState>
    {
        ...
        [ActionParameter(optional: true)] // Allows using scale=x for uniform scaling.
        public override float?[] Scale { get => AttemptUniformScale(); set => base.Scale = value; }
        [ActionParameter(optional: true)] // Allows using local scene position to set world position of the actor.
