...
namespace Naninovel.Actions
{
    ...
    /// </example>
    [ActionAlias("hideAll")]
    public class HideAllActors : NovelAction
    {
        private struct UndoData { public bool WasVisible; public NovelActorManager Manager; public string ActorId; }

        private List<UndoData> undoData;

        public override async Task ExecuteAsync ()
        {
            var managers = Engine.GetAllServices<NovelActorManager>();
