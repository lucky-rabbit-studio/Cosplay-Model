...
namespace Naninovel.Actions
{
    ...
    /// </summary>
    /// <remarks>
    /// This action is used under the hood when processing generic text lines, eg generic line `Kohaku: Hello World!` will be 
    /// automatically tranformed into `@print "Hello World!" actor:Kohaku` when parsing the novel scripts.<br/>
    ...
    /// </example>
    [ActionAlias("print")]
    public class PrintText : ModifyText, NovelAction.IPreloadable, NovelAction.ILocalizable
    {
        /// <summary>
        ...
        /// </summary>
        [ActionParameter("waitInput", true)]
        ...
        public async Task PreloadResourcesAsync ()
        {
            ...
            if (AutoVoicingEnabled) await AudioManager.PreloadVoiceAsync(AutoVoiceClipName);
        }
        ...
        public async Task UnloadResourcesAsync ()
        {
            ...
            if (AutoVoicingEnabled) await AudioManager.UnloadVoiceAsync(AutoVoiceClipName);
        }
        ...
        public override async Task ExecuteAsync ()
        {
            ...
            if (WaitForInput) Engine.GetService<NovelScriptPlayer>()?.EnableWaitingForInput();
        ...
        {
            if (UndoData.Executed && WaitForInput) Engine.GetService<NovelScriptPlayer>()?.DisableWaitingForInput();
