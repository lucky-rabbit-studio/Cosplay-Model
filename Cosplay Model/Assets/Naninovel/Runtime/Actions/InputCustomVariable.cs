...
namespace Naninovel.Actions
{
    ...
    /// player from saving the game when the UI is visible (eg, with `@hideText` action).
    /// </remarks>
    /// <example>
    ...
    /// </example>
    [ActionAlias("input")]
    public class InputCustomVariable : NovelAction, NovelAction.ILocalizable
    {
        /// <summary>
