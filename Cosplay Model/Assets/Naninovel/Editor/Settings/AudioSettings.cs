...
namespace Naninovel
{
    public class AudioSettings : ResourcefulSettings<AudioConfiguration>
    {
        ...
        protected override string ResourcesSelectionTooltip => "Use `@bgm %name%` or `@sfx %name%` in novel scripts to play a background music or sound effect of the selected audio clip.";
