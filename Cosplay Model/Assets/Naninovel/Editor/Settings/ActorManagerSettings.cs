...
{
    /// <summary>
    /// Derive from this class to create custom editors for <see cref="Configuration"/> assets of <see cref="NovelActorManager"/> services.
    /// </summary>
    ...
    public abstract class ActorManagerSettings<TConfig, TActor, TMeta> : ResourcefulSettings<TConfig> 
        ...
        where TMeta : NovelActorMetadata
    {
        ...
        protected virtual string MetadataToResourcesCategoryId (NovelActorMetadata metadata) => $"{metadata.LoaderConfiguration.PathPrefix}/{metadata.Guid}";
