    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 ComputeFragment(VertexOutput vertexOutput) : SV_Target
            {
                ...
                // Hide unrevealed text characters.
                color.a *= IsPositionOutsideRect(vertexOutput.WorldPos.xy, _CharClipRect);
                // Apply gradient fade to neighbour revealed chars.
                if (vertexOutput.WorldPos.y < _CharClipRect.w) // TODO: Handle chars fading on multiple lines.
                    color.a *= min((_CharClipRect.x - vertexOutput.WorldPos.x) / _CharFadeWidth, 1.0);
